...
CONFIG.NUM_SI {1} \
  ...
  # Create instance: concat_interrupts1, and set properties
  set concat_interrupts1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_interrupts1 ]
  set_property -dict [ list \
CONFIG.NUM_PORTS {2} \
 ] $concat_interrupts1
...
CONFIG.SINGLE_PORT_BRAM {1} \
  ...
  # Create instance: mb_bram_ctrl_3_bram, and set properties
  set mb_bram_ctrl_3_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.3 mb_bram_ctrl_3_bram ]
  set_property -dict [ list \
CONFIG.use_bram_block {BRAM_Controller} \
 ] $mb_bram_ctrl_3_bram
...
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO} \
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net mb_bram_ctrl_3_BRAM_PORTA [get_bd_intf_pins mb_bram_ctrl_3/BRAM_PORTA] [get_bd_intf_pins mb_bram_ctrl_3_bram/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_interrupts/s_axi]
  ...
  connect_bd_net -net concat_interrupts1_dout [get_bd_pins concat_interrupts1/dout] [get_bd_pins system_interrupts/intr]
  ...
  connect_bd_net -net logic_1_dout [get_bd_pins iop1/ext_reset_in] [get_bd_pins logic_1/dout] [get_bd_pins tracebuffer_pmods/A_TVALID]
  ...
  connect_bd_net -net pmod2sw_data_in_1 [get_bd_ports pmodJA_data_in] [get_bd_pins concat_pmods/In1] [get_bd_pins concat_pmods/In5] [get_bd_pins iop1/pmod2sw_data_in]
  connect_bd_net -net pmod_io_switch_0_sw2pmod_data_out [get_bd_ports pmodJA_data_out] [get_bd_pins concat_pmods/In0] [get_bd_pins concat_pmods/In4] [get_bd_pins iop1/sw2pmod_data_out]
  connect_bd_net -net pmod_io_switch_0_sw2pmod_tri_out [get_bd_ports pmodJA_tri_out] [get_bd_pins concat_pmods/In2] [get_bd_pins concat_pmods/In6] [get_bd_pins iop1/sw2pmod_tri_out]
  connect_bd_net -net proc_sys_reset_142M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins proc_sys_reset_142M/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins iop1/clk] [get_bd_pins mb_bram_ctrl_1/s_axi_aclk] [get_bd_pins mb_bram_ctrl_3/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins system_interrupts/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins proc_sys_reset_142M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/S00_ACLK] [get_bd_pins rst_processing_system7_0_166M/slowest_sync_clk] [get_bd_pins tracebuffer_pmods/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_142M/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in] [get_bd_pins rst_processing_system7_0_166M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins mb_1_intr_ack/Din] [get_bd_pins mb_1_reset/Din] [get_bd_pins processing_system7_0/GPIO_O]
  ...
  connect_bd_net -net rst_processing_system7_0_166M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/S00_ARESETN] [get_bd_pins rst_processing_system7_0_166M/peripheral_aresetn] [get_bd_pins tracebuffer_pmods/s_axi_aresetn]
  connect_bd_net -net tracebuffer_pmod_s2mm_introut [get_bd_pins concat_interrupts1/In0] [get_bd_pins tracebuffer_pmods/s2mm_introut]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins concat_interrupts1/In1] [get_bd_pins iop_interrupts/dout]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x20000000 [get_bd_addr_spaces tracebuffer_pmods/axi_dma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace portBus pmodJA_data_out -pg 1 -y 2310 -defaultsOSRD
preplace portBus pmodJA_data_in -pg 1 -y 2200 -defaultsOSRD
preplace inst constant_8bit_0 -pg 1 -lvl 2 -y 2310 -defaultsOSRD
preplace inst concat_interrupts1 -pg 1 -lvl 2 -y 760 -defaultsOSRD
preplace inst rst_processing_system7_0_166M -pg 1 -lvl 2 -y 460 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 960 -defaultsOSRD
preplace inst tracebuffer_pmods -pg 1 -lvl 4 -y 100 -defaultsOSRD
preplace inst system_interrupts -pg 1 -lvl 3 -y 1240 -defaultsOSRD
preplace inst iop_interrupts -pg 1 -lvl 1 -y 1700 -defaultsOSRD
preplace inst proc_sys_reset_142M -pg 1 -lvl 4 -y 540 -defaultsOSRD
preplace inst mb_1_reset -pg 1 -lvl 3 -y 1650 -defaultsOSRD
preplace inst iop1 -pg 1 -lvl 4 -y 1590 -defaultsOSRD
preplace inst logic_1 -pg 1 -lvl 3 -y 470 -defaultsOSRD
preplace inst concat_pmods -pg 1 -lvl 3 -y 2330 -defaultsOSRD
preplace inst mb_bram_ctrl_3_bram -pg 1 -lvl 6 -y 2030 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -y 2090 -defaultsOSRD
preplace inst processing_system7_0_axi_periph_1 -pg 1 -lvl 3 -y 260 -defaultsOSRD
preplace inst mb_bram_ctrl_1 -pg 1 -lvl 3 -y 1390 -defaultsOSRD
preplace inst mb_1_intr_ack -pg 1 -lvl 3 -y 1740 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 5 -y 1770 -defaultsOSRD
preplace inst mb_bram_ctrl_3 -pg 1 -lvl 5 -y 2030 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 380 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -y 390 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 1230 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 6 1 NJ
preplace netloc axi_mem_intercon_M01_AXI 1 5 1 2150
preplace netloc processing_system7_0_FCLK_CLK3 1 1 6 410 360 810 80 1250 200 1830 530 2190 570 2670
preplace netloc iop_interrupts_irq 1 3 3 NJ 420 NJ 520 2180
preplace netloc constant_8bit_0_dout 1 2 1 790
preplace netloc concat_interrupts1_dout 1 2 1 820
preplace netloc pmod_io_switch_0_sw2pmod_data_out 1 2 5 840 2210 NJ 2210 1780 2210 NJ 2210 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 800
preplace netloc rst_processing_system7_0_166M_peripheral_aresetn 1 2 3 800 60 1260 210 1840
preplace netloc processing_system7_0_GPIO_O 1 2 5 840 1790 NJ 1790 1760 1530 NJ 1530 2720
preplace netloc iop1_intr_ack_Dout 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 400 560 NJ 560 NJ 440 NJ 590 NJ 590 2710
preplace netloc mb_bram_ctrl_1_BRAM_PORTA 1 3 1 1230
preplace netloc pmod_io_switch_0_sw2pmod_tri_out 1 2 5 830 2190 NJ 2190 1770 2190 NJ 2190 NJ
preplace netloc processing_system7_0_axi_periph_1_M01_AXI 1 3 1 1200
preplace netloc processing_system7_0_M_AXI_GP1 1 2 5 830 520 NJ 450 NJ 550 NJ 550 2690
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 20 550 410 550 NJ 550 1210 400 NJ 580 NJ 580 2660
preplace netloc mb_1_reset_Dout 1 3 1 NJ
preplace netloc concat_pmods_dout 1 3 1 1240
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 2 3 NJ 1320 NJ 1320 1800
preplace netloc processing_system7_0_axi_periph_1_M00_AXI 1 3 1 1190
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 4 370 1400 840 1470 1210 1830 1830
preplace netloc xlconcat_0_dout 1 1 1 380
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ
preplace netloc logic_1_dout 1 3 1 1270
preplace netloc iop1_iop1_intr_req 1 0 5 30 1800 NJ 1800 NJ 1800 NJ 1800 1750
preplace netloc axi_interconnect_0_M00_AXI 1 5 1 2160
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 1850
preplace netloc S00_AXI_2 1 4 1 1820
preplace netloc mb_bram_ctrl_3_BRAM_PORTA 1 5 1 NJ
preplace netloc proc_sys_reset_142M_peripheral_aresetn 1 4 1 1770
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 4 390 1070 NJ 1070 NJ 1070 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 30 1150 410 1390 830 1460 1300 1450 1850 600 2170 600 2700
preplace netloc microblaze_0_debug 1 3 1 1280
preplace netloc tracebuffer_pmod_s2mm_introut 1 1 4 410 630 NJ 630 NJ 630 1750
preplace netloc rst_processing_system7_0_166M_interconnect_aresetn 1 2 3 820 530 NJ 340 N
preplace netloc processing_system7_0_FCLK_CLK1 1 3 4 1300 430 1800 540 2200 560 2680
preplace netloc pmod2sw_data_in_1 1 0 4 NJ 2200 NJ 2200 810 1600 1200
preplace netloc mdm_1_debug_sys_rst 1 3 1 1300
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 810
preplace netloc axi_mem_intercon_M00_AXI1 1 5 1 N
preplace netloc S00_ARESETN_1 1 4 1 1790
levelinfo -pg 1 0 200 620 1040 1570 2000 2450 2750 -top 0 -bot 2450
",
}
